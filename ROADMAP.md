...
### Milestone 11 — Enterprise Colour Workflow (`v0.6.0` – `v0.6.4`)
...
- [x] **Windows Authenticode Code Signing in Gitea CI** (`v0.6.4`): Integrated Tauri bundle signing hooks and Gitea Actions secret-based PFX materialization and ephemeral signing pipeline.
